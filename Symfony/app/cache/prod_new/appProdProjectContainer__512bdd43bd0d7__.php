...
class appProdProjectContainer__512bdd43bd0d7__ extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $a = $this->get('templating.loader');
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/assetic/config'), false)));
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'sf', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_diextra/doctrine/EntityManager_512bdd45207f1.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_b9e28b7c58a911d48831e41f0ad71545');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_b9e28b7c58a911d48831e41f0ad71545');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_b9e28b7c58a911d48831e41f0ad71545');
        ...
        $d->setProxyDir('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager512bdd45207f1_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), false, array(), array(0 => 'TestUnBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_security/expressions');
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new',
            ...
            'kernel.container_class' => 'appProdProjectContainer__512bdd43bd0d7__',
            ...
            'session.save_path' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/sessions',
            ...
            'router.resource' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/config/routing_prod.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_aop',
            ...
            'jms_di_extra.cache_dir' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_diextra/doctrine/EntityManager_512bdd45207f1.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager512bdd45207f1_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => 'C:/xampp/htdocs/PROJECTS/SYMFONY.2.1.V2/path/app/cache/prod_new/jms_security',
